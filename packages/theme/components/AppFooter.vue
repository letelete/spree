<template>
  <SfFooter :column="4" multiple class="footer">
    <SfFooterColumn :title="$t('components.app_footer.about_us')">
      <SfList>
        <SfListItem
    ...
    <SfFooterColumn :title="$t('components.app_footer.departments')">
      <SfList>
        <SfListItem
    ...
    <SfFooterColumn :title="$t('components.app_footer.help')">
      <SfList>
        <SfListItem
          v-for="item in help"
          :key="item"
    ...
    <SfFooterColumn :title="$t('components.app_footer.payment_and_delivery')">
      <SfList>
        <SfListItem
